...
void main() {
  ...
  targetColor.r = (1.0 - targetColor.r) * ( clamp(distanceToCenter, 0.0, 1.0) * 2.5) + targetColor.r;
  targetColor.g = (1.0 - targetColor.g) * ( clamp(distanceToCenter, 0.0, 1.0) * 2.5) + targetColor.g;
  targetColor.b = (1.0 - targetColor.b) * ( clamp(distanceToCenter, 0.0, 1.0) * 2.5) + targetColor.b;
